...
public extension Injector {
    ...
    func inject<R: Encodable>(path: String, plugin: @escaping () async throws -> R, injectionTime: WKUserScriptInjectionTime = .atDocumentEnd) {
    ...
    func inject<P0: Decodable, R: Encodable>(path: String, plugin: @escaping (P0) async throws -> R, injectionTime: WKUserScriptInjectionTime = .atDocumentEnd) {
